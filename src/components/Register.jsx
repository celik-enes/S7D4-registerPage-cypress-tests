...
export const errorMessages = {
  ...
  password: "En az 8 karakter, en az büyük harf, en az 1 küçük harf, en az 1 sembol ve en az 1 rakam içermelidir.",
}
...
export default function Register() {
  ...
  axios.post('https://6853ff5ea2a37a1d6f4ac097.mockapi.io/users', formData)
  .then(response => {
   ...
   <CardBody>
    <Form onSubmit={handleSubmit}> 
     <FormGroup>
      ...
      />
      {errors.ad && (
        <FormFeedback data-cy="error-message">{errorMessages.ad}</FormFeedback>
      )}
     </FormGroup>
     <FormGroup>
      <Label for="soyad">
 ...
 <CardFooter data-cy="response-message">
  ID : {id}
 </CardFooter>
</Card>
 );
